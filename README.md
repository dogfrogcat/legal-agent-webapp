...
`문서 작성` 모드에서는 내용증명 작성기가 표시됩니다. 환불, 임금체불, 보증금 반환, 의료·미용 피해, 게시물 삭제, 대여금 변제 유형을 선택하고 발신인/수신인/요구사항/증거를 넣으면 AI가 검토용 초안을 작성합니다. 초안은 협박·모욕·범죄 단정 표현을 줄이고, 발송 전 체크리스트와 위험 문구 대체안을 함께 제시하도록 설계되어 있습니다.
